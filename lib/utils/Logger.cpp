...
void Logger::logFull(float tpsPercent, float mapPercent, float pressure_kPa, float pressure_pct, float pressure_psi,
    ...
    btSerial.printf("%lu,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%d,%d,%s,%s\n",
                    ts, tpsPercent, mapPercent, pressure_kPa, pressure_pct, pressure_psi,
